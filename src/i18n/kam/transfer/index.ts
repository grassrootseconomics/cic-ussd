...
const kam_transfer: NamespaceTransferTranslation = {
  ...
  enteringAmount: 'CON Kewango kenene: {spendable|currency}\nIkia kiwango\n0. Syoka',
  enteringPin:
    'CON {recipient} nukwata {amount|currency} {symbol} kuma kwa {sender}\nIkia PIN yaku kuvitukithya\n0. Syoka',
  enteringRecipient: 'CON Ikia namba ya simu\n0. Syoka',
  exit: exit,
  invalidRecipient: 'CON {recipient} ya simu timbadekethye kana ndayele, tatethya ingi:\n0. Syoka',
  ...
  inviteSuccess: 'END Utamani waku wa kuthokya {invitee} mutandaoni wa sarafu network niweetekelwa.',
  mainMenu: mainMenu,
  transferError: 'END Wendekethyo waku winatekelwa, tata ingi kavinda kangi.',
  transferInitiated: 'END Woni niwatumwa. {recipient} nukukwata {amount|currency} {symbol} kuma kwa {sender}.'
}
