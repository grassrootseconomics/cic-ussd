...
const gax_transfer: NamespaceTransferTranslation = {
  ...
  enteringAmount: 'CON Kiwango ta Gubaa: {spendable|currency}\nAgham kekhai\n0. Dheebi',
  enteringPin: 'CON {recipient} in argad {amount|currency} {symbol} ir {sender}.\nPIN kekhai:\n0. Dheebi',
  enteringRecipient: 'CON Namba simuu kekhai\n0. Dheebi',
  exit: exit,
  invalidRecipient: 'CON {recipient} sun insajilan au dasaanit, mar dibii kekai:\n0. Dheebi',
  ...
  mainMenu: mainMenu,
  transferError: 'END Qarqarsi kanke inargam. Saadhi garii itdheebi',
  transferInitiated:
