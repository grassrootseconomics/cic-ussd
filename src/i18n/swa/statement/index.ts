...
const swa_statement: NamespaceStatementTranslation = {
  ...
  enteringPin: "CON Tafadhali weka PIN yako kuona taarifa ya matumizi\n0. Rudi",
  exit: exit,
  firstTransactionSet: "CON {transactions}\n11.Mbele\n00. Ondoka",
  loadError: "END Tatizo limetokea wakati wa kuangalia taarifa ya akaunti yako. Tafadhali jaribu tena baadaye.",
  mainMenu: mainMenu,
