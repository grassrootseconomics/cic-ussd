...
const swa_transfer: NamespaceTransferTranslation = {
    ...
    enteringAmount: 'CON Kiwango cha juu: {spendable|currency}\nWeka kiwango:\n0. Rudi',
    enteringPin:
    ...
    invalidRecipient: 'CON {recipient} haijasajiliwa au sio sahihi, tafadhali weka tena:\n0. Rudi',
    inviteError:
      'END Ombi lako la kumwalika {invitee} kwa matandao wa Sarafu halikufaulu. Tafadhali jaribu tena baadaye.',
    inviteSuccess: 'END Ombi lako la kumwalika {invitee} kwa matandao wa Sarafu limetumwa.',
    mainMenu: mainMenu,
    transferError: 'END Ombi lako halikufaulu. Tafadhali jaribu tena baadaye.',
    transferInitiated: 'END Ombi lako limetumwa. {recipient} atapokea {amount|currency} {symbol} kutoka kwa {sender}.'
}
