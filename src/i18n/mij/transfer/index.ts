...
const mij_transfer: NamespaceTransferTranslation = {
  ...
  enteringAmount: 'CON Chiwango cha dzulu: {spendable|currency}\nIka chaasi cha kuhuma:\n0. Uya nyuma',
  enteringPin: 'CON {recipient} yundahokera {amount|currency} {symbol} kulaa kwa {sender}.\nika PIN kala usawa\n0. Uya nyuma.',
  enteringRecipient: 'CON Ika namba ya simu.\n0. Uya Nyuma',
  exit: exit,
  invalidRecipient: 'CON {recipient} hii kaidzangwe sajiliwa ama kaisawa, unavoywa uyike kaheri:\n0. Uya nyuma',
  ...
  mainMenu: mainMenu,
  transferError: 'END Voyoro karifaulire. Tafadhali heza tena baadaye',
  transferInitiated:
