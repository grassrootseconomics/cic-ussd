...
#### [v0.2.21](https://github.com/grassrootseconomics/cic-ussd/compare/v0.2.20...v0.2.21)

> 28 November 2023

- Accommodate non-custodial interplay with USSD. [`#108`](https://github.com/grassrootseconomics/cic-ussd/pull/108)
- Implements fixes to correctly rebuild user in cache. [`#107`](https://github.com/grassrootseconomics/cic-ussd/pull/107)
- refactor(transfer): Accommodates no-custodial accounts in VPA and till transfers. [`#106`](https://github.com/grassrootseconomics/cic-ussd/issues/106)
- fix(graph): Corrects graphql query for address based on VPA. [`#106`](https://github.com/grassrootseconomics/cic-ussd/issues/106)
- fix(user): Implements fixes to correctly rebuild user in cache. [`#105`](https://github.com/grassrootseconomics/cic-ussd/issues/105)
- chore(changelog): Updates changelog. [`b854dee`](https://github.com/grassrootseconomics/cic-ussd/commit/b854dee3053b42b4e77ef5f92cc83273d3a7cda4)
